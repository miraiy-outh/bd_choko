...
def select_im_s():
    try:
        tmp = "SELECT * FROM image_sensor ORDER BY imageSensorId DESC LIMIT 10;"
...
def select_l_s():
    try:
        tmp = "SELECT * FROM level_sensor ORDER BY levelSensorId DESC LIMIT 10;"
...
def select_p_s():
    try:
        tmp = "SELECT * FROM photo_sensor ORDER BY photoSensorId DESC LIMIT 10;"
